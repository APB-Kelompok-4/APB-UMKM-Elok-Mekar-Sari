        ...
        IconButton(
          onPressed: () {
            ScaffoldMessenger.of(context).showSnackBar(
              const SnackBar(
                content: Text(
                  'Fitur ekspor laporan tersedia di tampilan laporan',
                ),
              ),
            );
          },
...
class DashboardTab extends StatelessWidget {
  ...
  int _getPendingComplaintCount() {
    ...
    return ComplaintService.complaints.where((complaint) {
      final isPending = complaint.status == ComplaintStatus.submitted ||
      ...
      final isUMKMProduct = complaint.productName != null &&
        ...
        return Card(
          ...
          child: ListTile(
            ...
            trailing: Text(
              ...
              style: TextStyle(
                color: complaint.priority == ComplaintPriority.high ||
...
class _ComplaintManagementTabState extends State<ComplaintManagementTab> {
  ...
  List<Map<String, dynamic>> get _filteredComplaints {
    return _complaints.where((complaint) {
      final priorityMatch = _selectedPriority == 'Semua' ||
                    ...
                    IconButton(
                      onPressed: () {
                        if (messageController.text.isNotEmpty) {
                          final updatedChat = List<Map<String, dynamic>>.from(
