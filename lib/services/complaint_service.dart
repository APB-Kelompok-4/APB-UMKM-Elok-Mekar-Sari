...
class ComplaintService {
  static final List<Complaint> _complaints = [
    Complaint(
      ...
      description: 'Produk yang saya terima sudah rusak, kemasan penyok.',
      ...
      rating: 4,
      chat: [
        {'sender': 'customer', 'message': 'Produk nugget lele yang saya terima dalam kondisi rusak', 'time': '2024-01-15 10:30'},
